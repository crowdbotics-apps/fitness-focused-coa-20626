"""fitness_focused_coa_20626 URL Configuration
...
admin.site.site_header = "Fitness Focused Coaching"
admin.site.site_title = "Fitness Focused Coaching Admin Portal"
admin.site.index_title = "Fitness Focused Coaching Admin"

# swagger
api_info = openapi.Info(
    title="Fitness Focused Coaching API",
    default_version="v1",
    description="API documentation for Fitness Focused Coaching App",
)
